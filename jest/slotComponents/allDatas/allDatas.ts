...
const slot = SlotComponent<Root, typeof subComp, "slot">()({
  data: {
    slot_num: 123,
    slot_str: "a",
  },
  ...
  computed: {
    slot_count() {
      return this.data.slot_num + this.data._slot_num + this.data.xxx_num + this.data.count;
    },
    _slot_Cstr() {
      return this.data.slot_str + this.data._slot_str + this.data._str + this.data._xxx_str;
    },
  },
  events: {
    slot_forCoverage: () => {
