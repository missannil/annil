...
type _GetCustomEventDocOfSubDoc<
  U extends CustomComponentReturnType,
  Result = {},
  TLast extends CustomComponentReturnType = Assert<Last<U>, CustomComponentReturnType>,
 ...
 */
export type GetCustomEventDocOfSubDoc<UnionSubDoc extends CustomComponentReturnType> = IsUnion<UnionSubDoc> extends true
