...
type _GetCustomEventDocOfSubDoc<
  ...
  Result = {},
  TLast extends CustomComponentDefinition = Assert<Last<U>, CustomComponentDefinition>,
 ...
 */
export type GetCustomEventDocOfSubDoc<UnionSubDoc extends CustomComponentDefinition> = IsUnion<UnionSubDoc> extends true
