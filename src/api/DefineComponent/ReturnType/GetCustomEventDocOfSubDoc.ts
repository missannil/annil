...
type _GetCustomEventDocOfSubDoc<
  U extends CustomComponentType,
  Result = {},
  TLast extends CustomComponentType = Assert<Last<U>, CustomComponentType>,
 ...
 */
export type GetCustomEventDocOfSubDoc<UnionSubDoc extends CustomComponentType> = IsUnion<UnionSubDoc> extends true
